...
function OptionsPrivate.CreateFrame()
  ...
  thanksList = thanksList .. lineWrapDiscordList(OptionsPrivate.Private.PatreonsList)

  local thanksListCJ = lineWrapDiscordList(OptionsPrivate.Private.PatreonsListCJ)
  local thanksListK = lineWrapDiscordList(OptionsPrivate.Private.PatreonsListK)
